...
<section class="hero"><div class="eyebrow">ON-DEVICE · JETSON · SIGNED ATTRIBUTION</div><h1>Disaster imagery in.<br>Person candidates out.</h1><p>Test Samik's frozen detector with a still disaster image or a video. Processing remains local on the Jetson. Red boxes are unverified <b>PERSON_CANDIDATE</b> outputs—not confirmed survivors and not disaster-type classifications.</p><div class="chips"><span class="chip">MODEL __MODEL_HASH__</span><span class="chip">SIGNER __SIGNER__</span><span class="chip">VIDEO SAMPLE EVERY __STRIDE__TH FRAME</span></div></section>
<div class="mode-grid">
<section class="panel"><div class="panel-title">01 · DISASTER PHOTO TEST</div><div id="photoDrop" class="drop"><div><span class="tag">FAST JURY TEST</span><h2>Drop Samik's test image</h2><p>JPEG · PNG · WebP</p></div><input id="photoFile" type="file" accept="image/jpeg,image/png,image/webp" hidden></div><div id="photoError" class="error"></div></section>
<section class="panel"><div class="panel-title">02 · DISASTER VIDEO TEST</div><div id="videoDrop" class="drop"><div><span class="tag">TEMPORAL SCAN</span><h2>Drop disaster footage</h2><p>MP4 · MOV · AVI · MKV · WebM</p></div><input id="videoFile" type="file" accept="video/*" hidden></div><div id="bar" class="bar"><i></i></div><div id="videoError" class="error"></div></section>
</div>
